...
//     }
//   }, [pathname, tourDetails.convertedCurrencyType, currencies, selected]);
...
//   const handleSelectCurrency = useCallback((currencyKey) => {
//     setSelected(currencyKey);

//     const conversionRate = selectedCurrency[currencyKey.toLowerCase()];

//     console.log(conversionRate, "rate");
//     const convertedCurrencyType = currencyKey;
//     const convertedCurrencySymbol = currency[currencyKey];
...
//                     "bg-primary text-black "
//                   }`}
//                   onClick={() => setSelected(currencyKey)}
//                 >
//                   <GiTwoCoins size={20} className="mr-2" />
//                   <span>{currencyKey}</span>
//                   <span className="mx-1">-</span>

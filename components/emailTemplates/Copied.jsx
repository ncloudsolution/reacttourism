    ...
    <Body style={main}>
      ...
      <Container style={container}>
        ...
        <Section style={section}>
          ...
          <Text style={text}>
            Last week, we kicked things off with round shapes. We rounded up the
            Pens from week one in our{" "}
          ...
          <Text style={text}>
            ...
            inspire a cool idea for your Pen. As always, the template is just as
            jumping off point. Feel free to incorporate the 🧊 in your creation,
            add more elements, or freeze it out completely and start over from
            scratch!
          </Text>
        ...
        <Text style={yellowSection}>
          ...
          . Well be watching and gathering the Pens into a Collection, and
          ...
          <Row>
            <Column style={ideas}>
              ...
              <Section style={yellowCard}>
                🌟
                <Text style={textCard}>
                  Theres more to cubes than just six square sides. There are
                  variations on the cube that could be fun to play with this
                  week: <Link style={blueLink}>cuboid shapes</Link> are
                  hexahedrons with faces that arent always squares. And if you
              ...
              <Section style={yellowCard}>
                🌟
                <Text style={textCard}>
                  Heres a mind-bending idea that can combine the round shapes
                  from week one with this weeks cube theme:{" "}
            ...
            <Column style={resources}>
              ...
              <Section style={blueCard}>
                ...
                <Text style={textCard}>
                  ...
                  how to build a 3D CSS cube from scratch in Amit Sheens
              ...
              <Section style={blueCard}>
                ...
                <Text style={textCard}>
                  ...
                  EntropyReverseds{" "}
                  <Link style={blueLink}>Pulsating Tesseract</Link>, Josetxus{" "}
                  <Link style={blueLink}>Rainbow Cuboid Loader</Link>, or Ana
                  Tudors <Link style={blueLink}>Pure CSS cuboid jellyfish</Link>
                  .
                </Text>
              </Section>
              ...
              <Section style={blueCard}>
                ...
                <Text style={textCard}>
                  ...
                  Ryan <Link style={blueLink}>Cube Sphere</Link>, Munir{" "}
                  <Link style={blueLink}>
                    3D Sphere to Cube Animation With Virtual Trackball
                  </Link>{" "}
                  and Ana <Link style={blueLink}>Infinitely unpack prism</Link>{" "}
                  for more mindbending cube concepts that test the boundaries of
                  how shapes interact with each other.
                </Text>
              </Section>
            </Column>
          </Row>

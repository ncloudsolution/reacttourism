...
function AbooutSrilanka() {
  return (
    <>
User
      <div className=" flex justify-center pb-[30px] pt-[30px] bg-gradient-to-b from-blue-100 to"  /*</>style={{ backgroundImage: `url(${srilanka4.src})`, backgroundSize: 'cover',  backgroundRepeat: 'no-repeat'}} */> 

...
import { SelectiveMinMaxDurationforTourPackage } from "@/libs/TimeDurationSorting";
...
const TourPackages = () => {
  ...
  const selectOptions = [
    ...
    { lable: "0-3 days", minvalue: 0, maxvalue: 3 },
    { lable: "3-5 days", minvalue: 3, maxvalue: 5 },
    { lable: "5-7 days", minvalue: 5, maxvalue: 7 },
    { lable: "7-10 days", minvalue: 7, maxvalue: 10 },
    { lable: "10+ days", minvalue: 10, maxvalue: 100 },
  ];
          ...
          {finalFilterdArray.map((place, index) => {
            ...
            return (
              ...
              <Link
                ...
                key={index}
                className="flex h-[450px] flex-col text-left  overflow-hidden   bigmd:w-[300px] sm:w-[500px] xs:w-[315px] xxs:w-[275px] xxxs:w-[250px] w-[220px]  rounded-xl shadow-lg xxxs:m-4 m-2 transition-all duration-3000 "
              >
                ...
                <div className="px-3 py-[15px] flex flex-col justify-between border-[3px] border-t-0 rounded-t-none border-primary rounded-xl">
                  <div className="flex flex-col border-2 border-transparent">
                    ...
                    {/* <div className="flex flex-wrap text-[14px] my-2 text-[#63687a]">
                  ...
                  <div className="flex py-[15px] flex-col border-2 border-transparent">
                    {/* {place.initialPrice && (
